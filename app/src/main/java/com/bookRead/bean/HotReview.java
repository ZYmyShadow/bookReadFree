package com.bookRead.bean;

import com.bookRead.base.Base;
...
public class HotReview extends Base {
     ...
     * rating : 3
     * content : 本人试毒500，前面还好可是后面真是索然无味，猪脚最开始魂魄寄存在造化玉碟碎片之中，后来结识盘古，但是连比较弱的混沌神魔都打不过的货色竟然帮助盘古开天？盘古就给他精血融合，
     * 那么为什么精血化形的12祖巫一点感应都没有？在盘古身陨是将50道鸿蒙紫气其中那遁去的一道.也就是那大道50中的1给了猪脚。可是之后的章节中直到猪脚成圣都再也未有看到，
     * 造化玉碟碎片作为猪脚混沌中的寄身之处也是莫名其妙不见鸟？猪脚作为圣人竟然不知道妻子玲玲前世自己死了之后发生了什么？他们可是夫妻有因果气运相连的啊，最最看不懂的是。
     * 为什么东皇太一是哥哥啊为什么他是妖皇，帝俊怎么就成弟弟了？为什么帝俊用的是混沌钟，为什么巫妖结仇仅仅是东皇太一帝俊出生散发的太阳真火本源被祝融吸收一些就在以后成为死敌？
     * 猪脚创下造化一脉自称造化天尊可是你造化一脉到底是什么教义？巫妖两族都杀戮不少人族可是为什么妖族能发现人族元神精魄可破巫族肉身，巫族就没有任何发现？要知道当时女娲以成圣，
     * 也就是说妖族当时在力量还是气运上都要强于巫族，那么天道会不帮巫族？不帮巫族等到巫妖大战如何同妖族两败俱伤？
